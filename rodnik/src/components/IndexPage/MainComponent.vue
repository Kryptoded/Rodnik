  ...
  <section class="layers">
    ...
    <div class="layers__container">
      <div
        ...
        :style="`background-image: url(${layer1});`"
      ></div>
      <div
        class="layers__item layer-2"
        :style="`background-image: url(${layer2});`"
      ></div>
      ...
      <div
        ...
        :style="`background-image: url(${layer5});`"
      ></div>
      <div
        class="layers__item layer-6"
        :style="`background-image: url(${layer6});`"
      ></div>
    </div>
  </section>
</template>
...
.hero-content {
  animation: slide-up 1.2s cubic-bezier(0.19, 1, 0.22, 1);
}
@keyframes slide-up {
  0% {
    opacity: 0;
